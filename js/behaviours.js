...
// add to chart
function addToCart() {
	var index = document.getElementById("addtocart").value;
	...
	p1.innerHTML = document.getElementsByName(index + "-title")[0].innerHTML + " " + document.getElementsByName(index + "-price")[0].innerHTML;
